...
params.pnbd_abe.m1
# -> Parameter Estimates match (Abe 2009) 2.5% 50% 97.5% log_lambda -3.74 -3.57 -3.37 log_mu -3.98 -3.74
# -3.42 var_log_lambda 1.19 1.42 1.69 cov_log_lambda_log_mu -0.11 0.29 0.76 var_log_mu 1.35 2.66 5.17
...
params.pnbd_abe.m2
# -> Parameter Estimates match Abe (2009); except for log_lambda_first and log_mu_first; note however, that
# via simulation we can establish that the implementation is able to re-identify the underlying parameters
