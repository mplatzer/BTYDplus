...
```{r, fig.show="hang", warning=FALSE, fig.width=7, fig.height=3, fig.cap="Figure X: MCMC traces and parameter distributions of cohort-level parameters"}
...
```{r, fig.show="hang", warning=FALSE, fig.width=7, fig.height=3, fig.cap="Figure X: MCMC traces and parameter distributions of individual-level parameters for customer 1"}
...
```{r, fig.show="hang", fig.width=7, fig.height=3, fig.cap="Figure X: Diagnostic Plots"}
op <- par(mfrow = c(1, 2))
