...
draws.m1 <- abe.mcmc.DrawParameters(cdnowCbs, 
              mcmc = 7500, burnin = 2500) # runs for ~33secs on a 2015 MacBook Pro
...
```{r, eval=FALSE, fig.caption = "Figure X: Distribution of regularity parameter k"}
# generate parameter draws
pggg.draws <- pggg.mcmc.DrawParameters(cbs) # runs for ~2.2mins on a 2015 MacBook Pro
# generate draws for holdout period
