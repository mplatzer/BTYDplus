...
sapply(draws.m2$level_1, function(customer.draws) {
  mat <- as.matrix(customer.draws)
  round(quantile(mat[, "lambda"], c(0.025, 0.5, 0.975)), 3)

  c(quant(mat[, c("lambda")]), quant(mat[, c("mu")]))
}
customer.draws <- draws.m2$level_1[[1]]
quant(as.matrixcustomer.draws)
