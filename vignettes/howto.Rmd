...
```{r, fig.show="hold", fig.width=7, fig.height=3, fig.cap="Timing Patterns for Sampled Grocery Customers"}
library(BTYDplus)
data("groceryElog")
set.seed(123)
...
```{r}
# estimates for customers with 40 weeks inactivity, and 1 to 5 repeat
# transactions in first 12 weeks
...
```{r}
# P(alive) for customers with 40 weeks inactivity, and 1 to 5 repeat
# transactions in first 12 weeks
