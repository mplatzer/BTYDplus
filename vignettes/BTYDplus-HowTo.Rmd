...
```{r, fig.show="hold", fig.width=7, fig.height=3, fig.cap="Diagnostic plots for model fit in calibration period and actuals vs. model predictions"}
...
```{r, eval=FALSE, fig.cap="Distribution of regularity parameter k"}
# load grocery dataset, if it hasn't been done before
if (!exists("groceryCBS")) {
  data("groceryElog")
  groceryCBS <- elog2cbs(groceryElog, T.cal = "2006-12-31")
